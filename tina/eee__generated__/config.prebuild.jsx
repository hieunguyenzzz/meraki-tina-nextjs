        ...
        },
        {
          ...
          ui: {
            defaultItem: {
              ...
              buttonText: "Th\xF4ng b\xE1o cho t\xF4i"
            }
          }
        },
        videoBlockSchema
...
// tina/collection/testimonial.ts
var Testimonial = {
  name: "testimonial",
  label: "Testimonials",
...
import React8, { useState, useContext } from "react";
...
var config = defineConfig({
  ...
  schema: {
    collections: [page_default, post_default, blog_default, journal_default, testimonial_default, author_default, tag_default, global_default]
  }
});
